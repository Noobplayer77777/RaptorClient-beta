...
public class ConfigSystem extends Thread {
    ...
    File dataFolder = new File(mc.mcDataDir, RaptorClient.NAME);
    File modFolder = new File(mc.mcDataDir, RaptorClient.NAME + "/mods/");
    ...
    public void saveOtherValues() {
        ...
        try {
            ...
            writer.write(RaptorClient.commandManager.prefix);
            writer.close();
        } catch (IOException e) { e.printStackTrace(); }
    }
    ...
    public void loadOtherValues() {
        ...
        try {
            ...
            RaptorClient.commandManager.prefix = reader.readLine().charAt(0);
        } catch (IOException e) { e.printStackTrace(); }
    }
