...
public class Utils {
    ...
    public static void drawRainbowFont(String text, int x, int y) {
        ...
        for (char c : charArray) {
            RaptorClient.cfont.drawStringWithShadow(String.valueOf(c), x + xOffset, y, new Color(getRGBWave(10, 1, 0.6f, 35L * (long) xOffset)));
            xOffset += RaptorClient.cfont.getStringWidth(String.valueOf(c)) + 0.275;
        }
    }
